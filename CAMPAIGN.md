...
- 2026-07-28 10:40 **SPARK V2 GATE: REJECTED** (official 1.2372 vs 1.2362, gain wash, termination 63% vs 79%, more repetition). 50K warm-restart steps on 300MB strictly-fresh text != beating the converged 234K cosine — the restart disruption cost what the fresh data was worth. spark.pt (v1) STANDS. Negative result documented in TIER7. **CAMPAIGN WORK COMPLETE** ~2 days ahead; hourly cron retired; verification sweep scheduled for 07-29, final close-out for 07-30 evening.
