...
**The two estimators disagree by ~0.005 in opposite directions for the two arms**
— the anchor's running loss sits 0.0028 *above* its fresh train-slice bpc, the
arm's 0.0026 *below* — and that is unexplained and referred (`EXP_018` §10 item
11). Until it is understood, **a running training loss is not a stand-in for a
train-split bpc anywhere in this project.**
